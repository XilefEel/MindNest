...
use crate::db::journal::{
    insert_journal_entry_into_db,
    get_journal_entries_by_nestling,
    update_journal_entry_in_db,
    delete_journal_entry_from_db,
    insert_journal_template_into_db,
    get_journal_templates_by_nestling,
    update_journal_template_in_db,
    delete_journal_template_from_db
};
...
#[tauri::command]
pub fn update_journal_entry(id: i64, title: String, content: String, entry_date: String) -> Result<(), String> {
