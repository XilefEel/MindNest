...
#[tauri::command]
pub fn create_nestling(db: tauri::State<AppDb>, data: NewNestling) -> AppResult<Nestling> {
    insert_nestling_into_db(&db, data)
}

#[tauri::command]
pub fn get_nestlings(db: tauri::State<AppDb>, nest_id: i64) -> AppResult<Vec<Nestling>> {
...
#[tauri::command]
pub fn update_nestling_timestamp(db: tauri::State<AppDb>, id: i64) -> AppResult<()> {
    update_nestling_timestamp_in_db(&db, id)
}

#[tauri::command]
pub fn delete_nestling(db: tauri::State<AppDb>, id: i64) -> AppResult<()> {
