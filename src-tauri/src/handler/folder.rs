...
#[tauri::command]
pub fn create_folder(db: tauri::State<AppDb>, data: NewFolder) -> AppResult<Folder> {
    insert_folder_into_db(&db, data)
}

#[tauri::command]
pub fn get_folders(db: tauri::State<AppDb>, nest_id: i64) -> AppResult<Vec<Folder>> {
...
#[tauri::command]
pub fn delete_folder(db: tauri::State<AppDb>, id: i64) -> AppResult<()> {
