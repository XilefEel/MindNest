...
export const toast = {
  success: (message: string) => {
    ...
    return sonnerToast.custom((id) => (
      <div
        className={cn(
          "flex w-90 flex-row items-center gap-2 rounded-lg border-l-6 border-green-500 bg-white p-3 shadow-lg dark:bg-gray-800",
  ...
  error: (message: string) => {
    ...
    return sonnerToast.custom((id) => (
      <div
        className={cn(
          "flex w-90 flex-row items-center gap-2 rounded-lg border-l-6 border-red-500 bg-white p-3 shadow-lg dark:bg-gray-800",
          activeBackgroundId && "bg-white/50 backdrop-blur-sm dark:bg-black/50",
        )}
      >
