...
export default function DashboardPage() {
  ...
  return (
    <div
      ...
      className="flex h-screen overflow-hidden bg-zinc-50 text-zinc-800 select-none dark:bg-zinc-900 dark:text-white"
    >
      {isSidebarOpen && (
        <div
      ...
      <div className="flex flex-1 flex-col">
        <header className="p-4 md:hidden">
          <button
            className="rounded-md bg-white p-2 transition-colors hover:bg-zinc-100 dark:bg-zinc-700 dark:text-zinc-100 dark:hover:bg-zinc-600"
