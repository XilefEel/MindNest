...
export default function SearchItem({
  ...
  return (
    <div
      ...
      className={cn(
        "flex flex-row items-center justify-between gap-2 p-2 px-4 transition-all duration-100 hover:bg-zinc-100 dark:hover:bg-zinc-700",
    ...
    >
      ...
      <div className="flex flex-1 items-center gap-1 text-zinc-500 dark:text-zinc-400">
