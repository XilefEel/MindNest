  ...
  return (
    <Popover open={isOpen} onOpenChange={setIsOpen}>
      ...
      <PopoverContent
        align="end"
        className={cn(
          "flex w-90 flex-row items-center justify-between rounded-full border border-gray-200 bg-white p-2 px-4 text-sm shadow-lg dark:border-gray-700 dark:bg-gray-800",
          activeBackgroundId &&
