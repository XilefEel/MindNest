            ...
            <div className="flex flex-col gap-0.5">
              {noteTemplates.map((template) => (
                <div
                  ...
                  className={cn(
                    "group flex items-center justify-between rounded-md px-2 py-1.5 transition-colors hover:bg-zinc-100 dark:hover:bg-zinc-700/50",
                    activeBackgroundId &&
                ...
                >
                  ...
                  <button
                    ...
                    className="rounded p-0.5 text-zinc-600 opacity-0 transition-opacity group-hover:opacity-100 hover:text-red-500 dark:text-zinc-400 dark:hover:text-red-400"
                  >
                    <Trash2 size={14} />
                  </button>
                </div>
          ...
          >
            ...
            <div className="flex items-center gap-2">
              ...
              <button
                ...
                className="rounded p-1 text-zinc-600 transition-colors hover:text-green-500 dark:text-zinc-400"
              >
                <Check size={16} />
              </button>
            </div>
