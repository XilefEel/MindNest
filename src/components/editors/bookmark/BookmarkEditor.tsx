    ...
    >
      ...
      >
        {bookmarks.length === 0 && !searchQuery && (
          <div className="flex flex-col items-center justify-center py-52 text-zinc-400 dark:text-zinc-500">
            <BookmarkPlus className="mb-3 size-16 text-zinc-300 dark:text-zinc-600" />
        ...
        {filteredBookmarks.length === 0 && searchQuery && (
          <div className="flex flex-col items-center justify-center py-52 text-zinc-400 dark:text-zinc-500">
            <SearchX className="mb-3 size-16 text-zinc-300 dark:text-zinc-600" />
