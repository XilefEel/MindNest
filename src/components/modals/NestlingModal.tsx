                    ...
                    className={cn(
                      ...
                      isSelected
                        ...
                        : activeBackgroundId
                          ...
                          : "border border-zinc-200 hover:border-zinc-300 hover:shadow-sm dark:border-zinc-700 dark:hover:border-zinc-500",
                    )}
                  >
                    <div
                      className={cn(
                    ...
                    <p
                      className={cn(
                        "flex-1 text-left text-sm text-zinc-800 dark:text-zinc-300",
                        isSelected &&
