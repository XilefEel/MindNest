...
export function SharedCard() {
  return (
    <div className="group relative overflow-hidden rounded-xl border border-gray-100 bg-white p-5 shadow-sm transition hover:-translate-y-0.5 hover:border-purple-200 hover:shadow-md dark:border-zinc-700 dark:bg-zinc-800 dark:hover:border-purple-500/50">
      ...
      <div className="flex flex-col gap-1">
        <h3 className="line-clamp-2 font-semibold text-gray-800 transition-colors group-hover:text-purple-600 dark:text-zinc-100 dark:group-hover:text-purple-400">
          Title Here
        </h3>
