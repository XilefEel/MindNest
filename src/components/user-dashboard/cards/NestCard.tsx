...
export default function NestCard({ nest }: { nest: Nest }) {
  ...
  return (
    <div
      ...
      className="group relative overflow-hidden rounded-xl border border-zinc-100 bg-white p-5 shadow-sm transition hover:-translate-y-0.5 hover:border-teal-200 hover:shadow-md dark:border-zinc-700 dark:bg-zinc-800 dark:hover:border-teal-500/50"
    >
      ...
      <div className="flex flex-col gap-1">
        <h3 className="line-clamp-2 text-base font-semibold text-zinc-800 transition-colors group-hover:text-teal-600 dark:text-zinc-100 dark:group-hover:text-teal-400">
          {nest.title}
        </h3>
