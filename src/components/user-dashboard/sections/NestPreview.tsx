    ...
    <div className="flex flex-col gap-5 overflow-y-auto rounded-lg border-l-4 border-teal-500 bg-white p-6 dark:bg-gray-800">
      <div className="flex items-center justify-between">
        ...
        <AddNestModal userId={user.id}>
          <div className="flex cursor-pointer items-center rounded-lg bg-teal-500 p-2 px-3 text-sm font-semibold text-white transition hover:bg-teal-700 dark:bg-white dark:text-black">
